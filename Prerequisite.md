...
---
Hash یعنی یه تابع یا فرایند که یه ورودی رو می‌گیره و یه خروجی مشخص تولید می‌کنه. این تبدیل یک طرفه است، یعنی از روی خروجی نمی‌تونی به ورودی اصلی برگردی. مثلاً اگه ورودی یه متن باشه، خروجی یه رشته طولانی از کاراکترها خواهد بود که بهش می‌گیم Hash.
